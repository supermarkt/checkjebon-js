...
### getPricesForProductsAtMultipleSupermarkets(productNames, maxSupermarketVisitCount, selectedSupermarketCodes)
...
**Example:**
```javascript
const result = await getPricesForProductsAtMultipleSupermarkets(
  ["melk", "brood", "kaas"],
...
cjb.getPricesForProductsAtMultipleSupermarkets(products, maxStores, selectedStores)
  .then(result => {
